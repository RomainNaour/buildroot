...
EFL_CORE_CONF_OPTS += --enable-xpresent
EFL_CORE_DEPENDENCIES += xlib_libXpresent
endif
...
EFL_CORE_CONF_OPTS += --enable-image-loader-webp=yes
EFL_CORE_DEPENDENCIES += webp
else
EFL_CORE_CONF_OPTS += --enable-image-loader-webp=no
endif
